...
gameOver=createSprite(width/2,height/2,width/2,height/4);
...
function createCash() {
  ...
  var cash = createSprite(Math.round(random(width/10, width-20),height/4, 10, 10));
...
function createDiamonds() {
  ...
  var diamonds = createSprite(Math.round(random(width/10, width-20),height/4, 10,10));
...
function createJwellery() {
  ...
  var jwellery = createSprite(Math.round(random(width/10, width-20),height/4, 10, 10));
...
function createSword(){
  ...
  var sword = createSprite(Math.round(random(width/10, width-20),height/4, 10, 10));
